...
if (not os.path.isfile("./Models_test/VAE-{}-{}_0.pth".format(latent_dimensions, l1))) or retrain == "y":
    ...
    np.savetxt("Loss_txt/Recon_loss_{}-{}_sigmoid.txt".format(latent_dimensions, l1), np.transpose([Recon_loss_t, Recon_loss_v, KL_loss_t, KL_loss_v]), fmt = "%1.5f", delimiter = ", ")
