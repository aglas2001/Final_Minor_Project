...
if (not os.path.isfile("./Model_Saves/model_lamda_complex_0.pth")) or retrain == "y":
    ...
    for i in range(n):
        ...
        for epoch in range(num_epochs):
            train_loss, MSE_t, KL_t = train(VAE, train_loader, optimizer)
            val_loss, MSE_v, KL_v = validate(VAE, val_loader)
    ...
    VAE.load_state_dict(torch.load("./Model_Saves/model_lamda_complex_0.pth"))
