...
data = mnist.data.to_numpy().astype('uint8')
...
std_data = scaler.transform(data).astype('uint8')
...
print("dimensionality after pca:",reduced_dim.shape)
...
plottable = np.reshape(data,(70000,28,28))
